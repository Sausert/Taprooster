...
const s: Record<string, React.CSSProperties> = {
  ...
  btn: { padding: "12px 28px", borderRadius: 12, background: "linear-gradient(135deg, #00e5c3, #00b89c)", color: "#0f0d1a", fontFamily: "'Exo 2', sans-serif", fontWeight: 700, fontSize: 14, border: "none", cursor: "pointer", letterSpacing: 1, textTransform: "uppercase", marginBottom: 12 },
  link: { fontSize: 13, color: "#8b80b0", textDecoration: "none", marginBottom: 40 },
